...
class ProjectAnalyzer:
    ...
    def _get_requirements_dependencies(self, agent_library_dir: Path) -> List[str]:
        ...
        return self.dependency_analyzer._get_requirements_dependencies(agent_library_dir)
    
    def _scan_python_imports(self, agent_library_dir: Path) -> List[str]:
        """Recursively scan Python files for import statements"""
        return self.dependency_analyzer._scan_python_imports(agent_library_dir)
